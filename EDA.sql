...
--Using cast to convert the data type of the value "Total_deaths"
...
-- GLOBAL NUMBERS (total cases, total_deaths, DeathPercentage)
...
-- Using CTE to perform Calculation on Partition By in previous query and compute the Percentage of the people that Vaccinated
